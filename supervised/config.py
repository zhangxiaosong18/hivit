...
_C.MODEL.SWIN.STEM_MLP_RATIO = 4.
...
_C.MODEL.VIT.INNER_PATCHES = 4
_C.MODEL.VIT.IN_CHANS = 3
_C.MODEL.VIT.EMBED_DIM = 384
_C.MODEL.VIT.DEPTHS = None
_C.MODEL.VIT.NUM_HEADS = 6
_C.MODEL.VIT.MLP_RATIO = 4.
_C.MODEL.VIT.STEM = 'PatchEmbed'
_C.MODEL.VIT.STEM_DEPTH = [1, 3, 0]
_C.MODEL.VIT.STEM_RATIO = 3.
_C.MODEL.VIT.PATCH_NORM = True
_C.MODEL.VIT.STEM_KERNEL = None
_C.MODEL.VIT.STEM_PAD = None
_C.MODEL.VIT.GLOBAL_POOL = True
_C.MODEL.VIT.APE = True
_C.MODEL.VIT.RPE = True
